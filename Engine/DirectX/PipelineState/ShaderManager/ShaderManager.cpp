...
void ShaderManager::create_vertex_shader() {
	// VSをコンパル
	vertexShaderBlob = ShaderCompiler::GetInstance().compile_shader(L"Engine/HLSL/3DObject/Object3d.VS.hlsl", L"vs_6_0");
	assert(vertexShaderBlob);
}

void ShaderManager::create_pixel_shader() {
	// PSをコンパイル
	pixelShaderBlob = ShaderCompiler::GetInstance().compile_shader(L"Engine/HLSL/3DObject/Object3d.PS.hlsl", L"ps_6_0");
